...
def run(arm) -> Any:
    ...
    steps = [
        ...
        ("Grab",                 {"A": "close", "B": "pick", "C": "pick", "D": "assembly"}),
        ("Pick Right S3",        {"A": "close", "B": "pick", "C": "max", "D": "assembly"}),
        ("Go Home (except A)",   {"A": "close", "B": "min",  "C": "max", "D": "neutral"}),
        ("Drop Left S1",         {"A": "close", "B": "pick", "C": "max", "D": "quality"}),
        ("Drop Left S2",         {"A": "close", "B": "pick", "C": "pick", "D": "quality"}),
